...
def main():
    ...
    data.n_train_lstm = data1.n_train_lstm + data2.n_train_lstm + data3.n_train_lstm
    data.n_train_vae = data1.n_train_vae + data2.n_train_vae + data3.n_train_vae
    data.n_val_lstm = data1.n_val_lstm + data2.n_val_lstm + data3.n_val_lstm
    data.n_val_vae = data1.n_val_vae + data2.n_val_vae + data3.n_val_vae
    #neu chay nprs chi cong data1 va data2, chay TEK phai cong ca data3
    data.test_set_vae['data'] = np.concatenate((data1.test_set_vae['data'],data2.test_set_vae['data'],data3.test_set_vae['data']),axis=0)
    data.train_set_vae['data'] = np.concatenate((data1.train_set_vae['data'],data2.train_set_vae['data'],data3.train_set_vae['data']),axis=0)
    data.val_set_vae['data'] = np.concatenate((data1.val_set_vae['data'],data2.val_set_vae['data'],data3.val_set_vae['data']),axis=0)
    data.train_set_lstm['data'] = np.concatenate((data1.train_set_lstm['data'],data2.train_set_lstm['data'],data3.train_set_lstm['data']),axis=0)
    data.val_set_lstm['data'] = np.concatenate((data1.val_set_lstm['data'],data2.val_set_lstm['data'],data3.val_set_lstm['data']),axis=0)
    # create a CNN model
